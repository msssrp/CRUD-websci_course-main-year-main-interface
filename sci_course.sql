...
CREATE TABLE `sci_years` (
  `cs_y_id` int(11) NOT NULL,
  `cs_year` varchar(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `sci_years`
--

INSERT INTO `sci_years` (`cs_y_id`, `cs_year`) VALUES
(1, '2566'),
(2, '2567');
...
--
ALTER TABLE `sci_years`
  MODIFY `cs_y_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
